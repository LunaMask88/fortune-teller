...
const zh = {
  ...
  home: {
    ...
    systems: [
      ...
      { icon: '卦', title: '六爻占卜',   desc: '本卦变卦，六爻动变，吉凶推演', slug: 'liuyao' },
      { icon: '🌸', title: '梅花易数',   desc: '先后天卦数，体用生克，瞬间起卦', slug: 'meihua' },
      { icon: '᛭', title: '北欧符文',   desc: '古日耳曼文字，命运之书，三符展开', slug: 'runes' },
      { icon: '⬡', title: '人类图',     desc: '能量中心·策略·内在权威，人生蓝图', slug: 'humandesign' },
      { icon: '🌙', title: '吠陀占星',   desc: '月亮星座·那沙特拉·大运周期', slug: 'vedic' },
      { icon: '字', title: '姓名学',     desc: '笔画数理，三才五格，命格吉凶', slug: 'xingming' },
    ],
  },
  ...
  lucky: {
    ...
    categories: {
      ...
      number:  '数字', plant:   '植物', symbol: '符号', clothing: '穿搭', food: '食补', other: '物件',
    },
    boosts: {
...
const en: typeof zh = {
  ...
  home: {
    ...
    systemsTitle: 'Twelve Divination Systems, Full Spectrum',
    ...
    systems: [
      ...
      { icon: '卦', title: 'Liu Yao · I Ching',        desc: 'Six-line hexagram, changing lines, fortune', slug: 'liuyao' },
      { icon: '🌸', title: 'Meihua Yi Shu',            desc: 'Plum Blossom numerology, body-use trigrams', slug: 'meihua' },
      { icon: '᛭', title: 'Nordic Runes',             desc: 'Elder Futhark, three-rune spread, fate', slug: 'runes' },
      { icon: '⬡', title: 'Human Design',             desc: 'Energy centers, strategy, inner authority', slug: 'humandesign' },
      { icon: '🌙', title: 'Vedic Astrology',          desc: 'Moon sign, Nakshatra, Dasha cycle', slug: 'vedic' },
      { icon: '字', title: 'Chinese Name Analysis',    desc: 'Stroke numerology, Three Talents, Five Grids', slug: 'xingming' },
    ],
  },
  ...
  lucky: {
    ...
    categories: {
      ...
      number:  'Number',  plant:   'Plant',   symbol: 'Symbol', clothing: 'Outfit', food: 'Food', other: 'Item',
    },
    boosts: {
